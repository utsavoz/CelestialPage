{
    ...
    class Item {
        constructor(el) {
            ...
            this.DOM.image.addEventListener('mouseenter', replaceImg);
            this.DOM.image.addEventListener('mouseleave', revertImg);

            function replaceImg(e) {
                const gifPath = e.currentTarget.dataset.gif;
                e.currentTarget.style.backgroundImage = "url(" + gifPath + ")";
            }

            function revertImg(e) {
                const gifPath = e.currentTarget.dataset.img;
                e.currentTarget.style.backgroundImage = "url(" + gifPath + ")";
            }
